...
void LveDevice::createInstance() {
  ...
  // For some reason switching to this fixes vulkan not being able to find
  // devices
  // https://github.com/blurrypiano/littleVulkanEngine/issues/39#issuecomment-1519084937
  VkInstanceCreateInfo createInfo = {};
  createInfo.sType = VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO;
